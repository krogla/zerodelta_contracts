...
/// @title ZeroDeltaDividendToken Contract
...
contract ZeroDeltaDividendToken is Ownable {
    ...
    ZeroDeltaDividendToken public parentToken;
    ...
    constructor (
        ...
        symbol = "ZDDT";
        decimals = 18;
        parentToken = ZeroDeltaDividendToken(_parentToken);
        parentSnapShotBlock = _parentSnapShotBlock == 0 ? block.number : _parentSnapShotBlock;
        creationBlock = block.number;

        //initial emission
        uint _amount = 100 * (10 ** uint256(decimals));
    ...
    function claimTokens(address _token) external onlyOwner {
        ...
        ZeroDeltaDividendToken token = ZeroDeltaDividendToken(_token);
